...
const MenuIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="https://drive.google.com/file/d/1MrkOgyyBh2kT6aMbMVurl_tiSB3Sk1Jo/view?usp=sharing" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
