...
const SearchResultsPage: React.FC = () => {
  ...
  useSEO({
    title: `Search Results for "${query || ''}" | Basha Bed Mart`,
    description: `Find results for your search query "${query || ''}" from our collection of mattresses, pillows, and bedding.`,
