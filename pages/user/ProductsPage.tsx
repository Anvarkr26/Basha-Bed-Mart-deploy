...
const ProductsPage: React.FC = () => {
  useSEO({
    title: 'All Products | Basha Bed Mart',
    description: 'Explore our full range of high-quality mattresses, pillows, sofa covers, and bedding. Filter by category, material, and price to find your perfect match.',
    keywords: 'mattresses, pillows, bedding, sofa covers, ortho mattress, memory foam pillow, cotton bed sheets'
  });
