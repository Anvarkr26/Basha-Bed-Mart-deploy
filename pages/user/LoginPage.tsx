...
const LoginPage: React.FC = () => {
  useSEO({
    title: 'Sign In | Basha Bed Mart',
    description: 'Sign in to your Basha Bed Mart account to access your profile, view orders, and enjoy a faster checkout experience.',
